...
")
  ...
  {
    read -r opus_in; read -r opus_cw; read -r opus_cr; read -r opus_out
    read -r sonnet_in; read -r sonnet_cw; read -r sonnet_cr; read -r sonnet_out
    read -r haiku_in; read -r haiku_cw; read -r haiku_cr; read -r haiku_out
  } <<< "$all_rates"
